...
def create_box_encoder(model_filename, input_name="images",
    ...
    def encoder(image, boxes, count):
        ...
        for box in boxes:
            ...
            # Save image patch
            model = "/home/peanut/Documents/cs231n_final_project/resources/networks/mars-small128.ckpt-68577.meta"
            path = "/home/peanut/Documents/cs231n_final_project/data/detection_bounding_boxes"
            image_path = os.path.join(path, "image_" + str(count) + ".jpeg")
