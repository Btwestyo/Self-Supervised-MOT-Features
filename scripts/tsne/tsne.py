...
from mot17_raw_dataset import MOT17Dataset, colors_per_class
from resnet import ResNet101

SCRIPT_DIR = os.path.dirname("/home/peanut/Documents/cs231n_final_project/scripts/generate_features/generate_features.py")
sys.path.append(os.path.dirname(
                os.path.dirname(SCRIPT_DIR)))
TITLE = "Pretrained ResNet"
...
def get_custom_model():
    s_dict = torch.load("/home/peanut/Documents/cs231n_final_project/scripts/training/checkpoints/mrunal_trained_model.pt")
    solver = s_dict['solver']
    solver.model.requires_grad = False
    return solver.model
...
def draw_rectangle_by_class(image, label):
    ...
    color = colors_per_class[int(label)]
...
def main():
    path = "/home/peanut/Documents/cs231n_final_project/data/MOT17/train/MOT17-09-SDP"
